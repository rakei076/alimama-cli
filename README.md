...
| 例子 | "上周关键词推广花了 ¥12,345" | "现在关键词推广 N 个计划都在跑，最大日预算 ¥XXX" |
...
```
#  名称                            花费    成交     ROI    点击    CTR
1  <计划 A 名字>              ¥123   ¥1,234  10.03   456   5.6%   🟢
2  <计划 B 名字>              ¥234   ¥2,345  10.02   567   4.5%   🟢
10 <计划 J 名字>              ¥12    ¥0       0.00    34   3.4%   🔴
```
...
| 夜间禁跑 | 1:00 – 6:00（可用 `ALIMAMA_BYPASS_CURFEW=1` 跳过）|
